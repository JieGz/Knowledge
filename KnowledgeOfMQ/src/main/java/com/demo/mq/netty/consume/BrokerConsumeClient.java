 ...
 * @date 2019/02/09
 */
public class BrokerConsumeClient {
    private final String host;
    private final int port;

    public BrokerConsumeClient(String host, int port) {
        this.host = host;
        this.port = port;
    }
            ...
            b.group(group)
                    ...
                    .handler(new ChannelInitializer<SocketChannel>() {
                        ...
                        protected void initChannel(SocketChannel ch) throws Exception {
                            ...
                            ch.pipeline().addLast(new BrokerConsumeClientHandler());
                        }
                    });
    ...
    public static void main(String[] args) throws Exception {
        new BrokerConsumeClient("127.0.0.1", 8887).start();
    }
}
