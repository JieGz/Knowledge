...
public class BrokerProduceClientHandler extends SimpleChannelInboundHandler<String> {
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        ByteBuf byteBuf = Unpooled.copiedBuffer("服务端小哥哥,现在几点了?", CharsetUtil.UTF_8);

        System.out.println(" 连接建立之后马上会被回调:" + byteBuf.toString(CharsetUtil.UTF_8));
